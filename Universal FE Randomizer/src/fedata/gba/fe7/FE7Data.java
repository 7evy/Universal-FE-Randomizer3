...
public class FE7Data implements GBAFEShopProvider, GBAFECharacterProvider, GBAFEClassProvider, GBAFEItemProvider, GBAFEShufflingDataProvider, GBAFETextProvider, GBAFEStatboostProvider {
...
//		if (effectivenessPtr == 0xC97ECBL) { return AdditionalData.DRAGON_EFFECT; } // Used for Aureola. It's Dragon + Dark Druid.
	...
	public enum Shops implements GBAFEShop {
		...
		public long getPointerOffset() {
			return pointerOffset; // wrong pointers?
		}

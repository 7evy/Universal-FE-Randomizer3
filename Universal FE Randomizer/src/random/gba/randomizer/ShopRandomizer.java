		...
		for (GBAFEShop shop : allShops) {
			...
			for (GBAFEShop currentShop : linked) {
				...
				case EARLY:
					...
					break;
				case MID:
					// 30% early, 45% mid, 20% late, 4% secret, 1% rare secret
					distributor.addItem(ItemQuality.EARLY, 30);
					distributor.addItem(ItemQuality.MID, 45);
					...
					break;
				case LATE:
					// 25% early, 25% mid, 40% late, 8% secret, 2% rare secret
					distributor.addItem(ItemQuality.EARLY, 25);
					distributor.addItem(ItemQuality.MID, 25);
					distributor.addItem(ItemQuality.LATE, 40);

...
public class DebugPrinter {
	...
	public enum Key {
		...
		GBA_TEXT_CODE_CHANGE("GBAFE Text Change"), PROMOTION_RANDOMIZATION("Promotion Randomization"), GBA_RANDOM_RECRUITMENT("GBA Random Recruitment"), LZ77("LZ77"), GBA_SHOP_LOADER("Shop Loader"),
